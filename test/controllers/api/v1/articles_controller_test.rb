...
class Api::V1::ArticlesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create api_v1_article" do
    assert_difference("Api::V1::Article.count") do
      post api_v1_articles_url, params: { api_v1_article: { body: @api_v1_article.body, release_date: @api_v1_article.release_date, title: @api_v1_article.title } }, as: :json
    end
  ...
  test "should update api_v1_article" do
    patch api_v1_article_url(@api_v1_article), params: { api_v1_article: { body: @api_v1_article.body, release_date: @api_v1_article.release_date, title: @api_v1_article.title } }, as: :json
    assert_response :success
  end
